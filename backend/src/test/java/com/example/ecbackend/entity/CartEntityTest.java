...
@DisplayName("Cart: カートエンティティのテスト")
class CartEntityTest {

    @Test
    @DisplayName("カートエンティティのプロパティ設定と取得")
    ...
    @Test
    @DisplayName("カートエンティティのnullプロパティ")
    void shouldHandleNullProperties() {
        // Given: プロパティを設定していない新しいカートエンティティ
        Cart cart = new Cart();
    ...
    @Test
    @DisplayName("カートエンティティのプロパティ更新")
    void shouldUpdateCartProperties() {
        // Given: 初期値を持つカートエンティティ
        Cart cart = new Cart();
        cart.setId(1L);
